...
import com.example.androidfolloupstest.Superadmin.SuperAdmin_InstructorActivity
import com.example.androidfolloupstest.Superadmin.SuperAdmin_Notificaciones
import com.example.androidfolloupstest.Superadmin.SuperAdmin_Perfil_SuperAdmin

class HomeSuperAdmin : ComponentActivity() {
        ...
        Column(modifier = Modifier
            ...
            Column(
                ...
                ActionButton("Administradores", R.drawable.administrador) {
                    ...
                    startActivity(Intent(this@HomeSuperAdmin, SuperAdmin_AdministradoresActivity::class.java))
                }

                ActionButton("Instructores", R.drawable.instructor_icono) {
                    Log.d("MainActivity", "Instructores button clicked")
                    startActivity(Intent(this@HomeSuperAdmin, SuperAdmin_InstructorActivity::class.java))
                }
                ActionButton("Aprendices", R.drawable.aprendiz_icono) {
                    Log.d("MainActivity", "Aprendices button clicked")
                    startActivity(Intent(this@HomeSuperAdmin, SuperAdmin_ApprenticeActivity::class.java))
                }
